...
- `all`: just like `index-first`, but also inspect subdirectories even if the _root index file_ exists.
...
| :-----------------: | :------------------: | :-------------------------------------: | :-------------: |
|       `mode`        | `index-first`, `all` |     Subpath exports generation mode     | **index-first** |
